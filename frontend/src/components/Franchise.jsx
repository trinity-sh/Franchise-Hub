      ...
      <div className="franchise">
        <Card className="custom-card">
          ...
          />
            ...
            <span className="industry">{item.content.personal_details.industry}</span>
            ...
            <Card.Text>
              ...
              <Row>
                ...
                <Col>
                  <span>{item.content.property_details.min} - {item.content.property_details.max}</span>
                </Col>
              </Row>
              <Row>
                <Col>
                ...
                <Col>
                  <span>{item.content.personal_details.no_of_franch_outlets}</span>
                </Col>
              </Row>
            </Card.Text>
