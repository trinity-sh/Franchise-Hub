            ...
            <div className="container business">
                <Card className="business-card">
                    ...
                    <Card.Body>
                        <Row>
                            <Col>
                                <span>About Us: {item.content.personal_details.business_desc}</span> <br />
                            ...
                            <Col className="column-2">
                                ...
                                <span>{item.content.property_details.floor_area_req.max} - {item.content.property_details.floor_area_req.min} sq. ft</span> <br />
                                <span className="text-muted">Franchise outlets</span> <br />
                                <span>{item.content.personal_details.no_of_franch_outlets}</span> <br />
                            </Col>
                        </Row>
                    </Card.Body>
                </Card>
